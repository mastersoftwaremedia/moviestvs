...
import {fetchMovies,fetchShows,fetchBanner,addUserToFirebase} from '../actions'
	...
	render(){
		...
		return(
			<div>
				...
				<NewsLetter authenticated={this.props.authenticated} />
				<Footer />
			</div>
		)
	}
...
export default connect(mapStateToProps,{
	fetchMovies,fetchShows,fetchBanner, addUserToFirebase})(Home)